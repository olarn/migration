...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "temp_stg_case_inprogress_log")
public class TempStgCaseInProgressLogModel {
    @Id
...
//    private String origin;
    ...
    public TempStgCaseInProgressLogModel(
            StgCaseInProgressModel stgCaseInProgressModel,
            BatchMigrationDataRequest batchMigrationDataRequest,
            Long jobExecutionId,
            BatchRecordStatusEnum batchStatus
    ) {
        BeanUtils.copyProperties(stgCaseInProgressModel, this, "tempStagingInProgressId");
        BeanUtils.copyProperties(batchMigrationDataRequest, this);

        this.jobExecutionId = jobExecutionId;
        this.batchRecordStatus = batchStatus;
    }
}