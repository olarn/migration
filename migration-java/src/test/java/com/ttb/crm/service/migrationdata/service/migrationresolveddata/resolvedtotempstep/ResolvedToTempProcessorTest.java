...
class ResolvedToTempProcessorTest {
    ...
    void setUp() throws Exception {
        ...
        processor = new ResolvedToTempProcessor(batchRequestJson);
        ...
        Field field = ResolvedToTempProcessor.class.getDeclaredField("stepExecution");
    ...
    void testConstructorThrowsExceptionOnInvalidJson() {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> new ResolvedToTempProcessor(invalidJson));
    ...
    void testProcessReturnsNullOnException() {
        ...
        assertThrows(RuntimeException.class, () -> processor.process(new StgCaseInProgressModel()), "Simulated error");
    }
}